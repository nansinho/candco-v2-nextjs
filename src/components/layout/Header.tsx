...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-sidebar-border bg-sidebar/80 px-4 backdrop-blur-md sm:px-6">
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="ml-2 flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-xs font-medium text-sidebar-foreground">
          N
        </div>
      </div>
    </header>
