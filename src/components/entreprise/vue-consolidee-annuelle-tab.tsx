    ...
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-dashed border-border/60 bg-muted/10 p-8 text-center">
          <BarChart3 className="mx-auto h-8 w-8 text-muted-foreground-faint" />
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border border-border/60 bg-card p-4 space-y-3">
          ...
          {data.plan.budgetTotal > 0 && (
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground-subtle text-right">{planPct}% engagé</p>
            </div>
          )}
        ...
        <div className="rounded-lg border border-primary/30 bg-primary/5 p-4 space-y-3">
          ...
          <div className="text-xs text-muted-foreground-subtle space-y-0.5">
