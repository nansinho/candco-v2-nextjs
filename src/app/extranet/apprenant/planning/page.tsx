  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Vue calendrier de vos creneaux</p>
      </div>
      <div className="rounded-lg border border-border/60 bg-card p-12 text-center">
        ...
        <p className="mt-3 text-sm font-medium text-muted-foreground/60">Le planning sera bientot disponible</p>
      </div>
    </div>
  );
}
