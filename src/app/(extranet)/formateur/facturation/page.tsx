    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Creez et suivez vos factures vers l&apos;organisme de formation
        </p>
      </div>
      <div className="rounded-lg border border-border/60 bg-card p-12 text-center">
        ...
        <p className="mt-3 text-sm font-medium text-muted-foreground/60">
          La facturation sera bientot disponible
        </p>
        <p className="mt-1 text-xs text-muted-foreground/40">
          Vous pourrez creer des factures pre-remplies (tarif jour x nombre de jours).
        </p>
      </div>
    </div>
  );
