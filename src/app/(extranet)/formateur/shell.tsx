...
import { EXTRANET_FORMATEUR_NAV } from "@/lib/constants";

export function ExtranetFormateurShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-background">
      <SidebarExtranet
        navItems={EXTRANET_FORMATEUR_NAV}
