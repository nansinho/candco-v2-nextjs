...
export default function ProduitsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold tracking-tight">Produits de formation</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Gerez votre catalogue de formations, programmes, tarifs et objectifs pedagogiques
        </p>
      </div>
